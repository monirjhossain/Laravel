        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide overlay">
                    <div class="single-slider slide-inner" style="background: url('{{ asset('uploads/slider_photos') }}/{{ $slider->slider_image }}')">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-12 col-lg-9 col-12">
                                    <div class="slider-content">
                                        <div class="slider-shape">
                                            ...
                                            <a href="{{ $slider->button_link }}" data-swiper-parallax="-300">{{ $slider->button_text }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
