                        ...
                        <form method="post" action="{{ url('/update/product/post') }}" enctype="multipart/form-data">
                          @csrf
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="product_short_description" value="{{ $product_short_description ?? '' }}">
                            </div>

                            <div class="form-group">
                              <label for="exampleInputEmail1">Product Long Description</label> 
                              <input type="text" class="form-control" name="product_short_description" value="{{ $product_long_description ?? '' }}">
                            </div>


                            <div class="form-group">
                              <label for="exampleInputEmail1">Current product Photo</label> 
                              <img src="{{ asset('uploads/product_photos') }}/{{ $product_photo }}" class="form-control"  alt="">
                            </div>

                            <div class="form-group">
                              <label for="exampleInputEmail1">New product Photo</label> 
                              <input type="file" class="form-control" name="new_product_photo" value="{{ $product_photo }}">
                            </div>
